...
export enum ACTION {
  ...
  SEARCH_CHANNEL = 'searchChannels',
  SEARCH_USER = 'searchUsers',
  SEARCH_FRIEND = 'searchFriends',
  SEARCH_MEMBER = 'searchMembers',
  LIST_SUGGEST_FRIEND_BY_TYPE = 'listSuggestedFriendByType',
  GET_STICKER_COLLECTION = 'getStickerCollection',
  GET_STICKER = 'getSticker',
  LIST_STICKER = 'listStickers',
  LIST_MESSAGE_FRAGMENT = 'listMessageFragments',
  ...
  LIST_MESSAGE_REACTION = 'listMessageReactions',
  LIST_DM_MESSAGE_FRAGMENT = 'listDmMessageFragments',
  GET_DM_MESSAGE = 'getDmMessage',
  LIST_BLOCK_USER = 'listBlockedUsers',
  GET_USER_BY_USERNAME = 'getUserByUsername',
  GET_INVITATION = 'getInvitation',
  LIST_INVITATION = 'listInvitation',
  LIST_INCOMING_FRIEND_REQUEST = 'listInComingFriendRequests',
  LIST_OUTGOING_FRIEND_REQUEST = 'listOutGoingFriendRequests',
  GET_FRIEND = 'getFriend',
  LIST_FRIEND = 'listFriends',
  LIST_INCOMING_MESSAGE_REQUEST = 'listInComingMessageRequests',
  LIST_OUTGOING_MESSAGE_REQUEST = 'listOutGoingMessageRequests',
  LIST_CHANNEL = 'listChannels',
  LIST_DM_CHANNEL = 'listDmChannels',
  GET_DM_CHANNEL = 'getDmChannel',
  LIST_BANNED_USER = 'listBannedUsers',
  ...
  LIST_ALL_CHANNEL = 'listAllChannels',
  ...
  FORWARD_MESSAGE_CHANNEL = 'forwardMessagesToChannel',
  ...
  UPDATE_MEDIA_ATTACHMENT = 'updateMediaAttachments',
