    ...
    import { validateDeleteAllMessageOnlyMe } from '../validates/delete-all-message-only-me/validate-delete-all-message-only-me';
    import fs from 'fs';
    ...
    import { DeleteAllMessageOnlyMeResponse } from '../dto-response/delete-all-message-only-me.response';
    import { validateAfterLogic } from '../validates/send-location/validate-send-location-after';

    describe('Testcase for delete-all-message-only-me', () => {
        let totalTests = 0;
        let passedLogic = 0;
        let failedTests = [];
        let logicTests = [];
        ...
        afterEach(async () => {
          ...
          if (messageId) {
            ...
            it('Test case # 1 with expect errors ["workspaceId should not be empty","channelId should not be empty"] ', async () => {
             testNumber = 1;
              totalTests++;
              ...
              const requestUrl = `${globalThis.url}/Message/DeleteAllMessagesOnlyMe?${urlParams}`;
            ...
            try {
              ...
              if(response.status === 201){
                  ...
                  const dtoInstance = plainToClass(DeleteAllMessageOnlyMeResponse, data);
                  const validateLogic = await validateDeleteAllMessageOnlyMe(dtoInstance, resolvedData);
            ...
            it('Test case # 2 with expect errors ["workspaceId should not be empty","channelId must be a string"] ', async () => {
             testNumber = 2;
              totalTests++;
            ...
            it('Test case # 3 with expect errors ["workspaceId should not be empty"] ', async () => {
             testNumber = 3;
              totalTests++;
            ...
            it('Test case # 4 with expect errors ["workspaceId must be a string","channelId should not be empty"] ', async () => {
             testNumber = 4;
              totalTests++;
            ...
            it('Test case # 5 with expect errors ["workspaceId must be a string","channelId must be a string"] ', async () => {
             testNumber = 5;
              totalTests++;
            ...
            it('Test case # 6 with expect errors ["workspaceId must be a string"] ', async () => {
             testNumber = 6;
              totalTests++;
            ...
            it('Test case # 7 with expect errors ["channelId should not be empty"] ', async () => {
             testNumber = 7;
              totalTests++;
            ...
            it('Test case # 8 with expect errors ["channelId must be a string"] ', async () => {
             testNumber = 8;
              totalTests++;
            ...
            it('Test case # 9 with expect errors [] ', async () => {
             testNumber = 9;
              totalTests++;
      ...
      afterAll(async () => {
        ...
        const folderPathLogic = path.join(__dirname, '../reports/delete-all-message-only-me');
        ...
        const resultContent = `
=== Test Reports for DTO "delete-all-message-only-me" ===
Host: ${globalThis.url}
Endpoint: /Message/DeleteAllMessagesOnlyMe
Summary: 
...
${failedTests.map((failCase) => `
  - Testcase #${failCase.testcase}
    ...
    === Test Reports Logic for DTO "delete-all-message-only-me" ===
    Host: ${globalThis.url}
    Endpoint: /Message/DeleteAllMessagesOnlyMe
    Error: 
...
const resultFilePath = path.join(folderPath, 'delete-all-message-only-me.txt');
const resultFilePathLogic = path.join(folderPathLogic, `delete-all-message-only-me.${getTime()}.txt`);
