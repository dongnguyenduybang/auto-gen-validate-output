    ...
    import { validateAfterLogic } from '../validates/add-message-reaction/validate-add-message-reaction-after';
          ...
          if (!resolveVariables("{{messageId}}")) {
            ...
            it('Test case # 256 with expect errors [] ', async () => {
             testNumber = 256;
              ...
              const requestUrl = `${globalThis.url}/Message/AddMessageReaction`;
            ...
            try {
              ...
              if(response.status === 201){
                  ...
                  const validateLogic = await validateAddMessageReaction(dtoInstance, resolvedData);
