    ...
    describe('Testcase for mock-user', () => {
        ...
        let failedTests = [];
          ...
          it('Test case #110 with expect errors ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity should not be empty","quantity must not be less than 1","quantity must not be greater than 100"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #110',
                  expected: ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity should not be empty","quantity must not be less than 1","quantity must not be greater than 100"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #115 with expect errors ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity should not be empty","quantity must not be less than 1","quantity must not be greater than 100"] ', async () => {
            totalTests++;
          ...
          it('Test case #120 with expect errors ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity should not be empty","quantity must not be less than 1","quantity must not be greater than 100"] ', async () => {
            totalTests++;
          ...
          it('Test case #124 with expect errors ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity must not be less than 1","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #124',
                  expected: ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity must not be less than 1","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
              ...
              const expectedError = ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity must not be less than 1","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"];
              const sortedReceived = [...error.response?.data?.error?.details || []].sort();
              const sortedExpected = [...expectedError].sort();
              if (JSON.stringify(sortedReceived) !== JSON.stringify(sortedExpected)) {
                failedTests.push({
          ...
          it('Test case #125 with expect errors ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity must not be less than 1","quantity must not be greater than 100"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #125',
                  expected: ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity must not be less than 1","quantity must not be greater than 100"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
              ...
              const expectedError = ["prefix must be a string","quantity must be a number conforming to the specified constraints","quantity must not be less than 1","quantity must not be greater than 100"];
              const sortedReceived = [...error.response?.data?.error?.details || []].sort();
              const sortedExpected = [...expectedError].sort();
              if (JSON.stringify(sortedReceived) !== JSON.stringify(sortedExpected)) {
                failedTests.push({
          ...
          it('Test case #126 with expect errors ["prefix must be a string","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #126',
                  expected: ["prefix must be a string","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #127 with expect errors ["prefix must be a string","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
          ...
          it('Test case #128 with expect errors ["prefix must be a string","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
          ...
          it('Test case #129 with expect errors ["prefix must be a string","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #129',
                  expected: ["prefix must be a string","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #130 with expect errors ["prefix must be a string"] ', async () => {
            totalTests++;
          ...
          it('Test case #131 with expect errors ["prefix must be a string","quantity must not be less than 1","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #131',
                  expected: ["prefix must be a string","quantity must not be less than 1","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #132 with expect errors ["prefix must be a string","quantity must not be less than 1","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
          ...
          it('Test case #133 with expect errors ["prefix must be a string","quantity must not be less than 1","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
          ...
          it('Test case #134 with expect errors ["prefix must be a string","quantity must not be less than 1","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #134',
                  expected: ["prefix must be a string","quantity must not be less than 1","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #135 with expect errors ["prefix must be a string","quantity must not be less than 1"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #135',
                  expected: ["prefix must be a string","quantity must not be less than 1"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #136 with expect errors ["prefix must be a string","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #136',
                  expected: ["prefix must be a string","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #137 with expect errors ["prefix must be a string","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
          ...
          it('Test case #138 with expect errors ["prefix must be a string","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge should not be empty","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
          ...
          it('Test case #139 with expect errors ["prefix must be a string","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #139',
                  expected: ["prefix must be a string","quantity must not be greater than 100","badge must be a number conforming to the specified constraints","badge must be one of the following values: 0, 1, 2, 3"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
          ...
          it('Test case #140 with expect errors ["prefix must be a string","quantity must not be greater than 100"] ', async () => {
            totalTests++;
            ...
            try {
              ...
              if (errors.length > 0) {
                ...
                failedTests.push({
                  name: 'Test case #140',
                  expected: ["prefix must be a string","quantity must not be greater than 100"],
                  actual: errors.map(err => err.toString())
                });
                throw new Error('Validation failed');
              } else {
        ...
        afterAll(() => {
          ...
          const resultFilePath = path.join(__dirname, '../reports', 'mock-user-results.txt');
          ...
          const resultContent = `
=== Test Results for DTO "mock-user" ===
...
`;
          ...
          console.log(`Kết quả đã được ghi vào file: ${resultFilePath}`);
        });
      });
