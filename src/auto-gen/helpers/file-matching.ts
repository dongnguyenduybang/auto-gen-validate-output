...
export function validateDtoName(dtoName: string): { status: boolean; data: any } {
...
// recent inquirer
export function addToRecentSelections(item: RecentSelection, recentSelections: RecentSelection[]): void {
