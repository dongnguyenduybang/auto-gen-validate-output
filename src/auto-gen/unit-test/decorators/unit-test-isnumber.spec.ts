...
describe("Unit test for decorators IsNumber", () => {
  it("should define metadata type isNumber correctly", () => {
    const metadataType = Reflect.getMetadata("type", TestClass.prototype, "age");
  ...
  it("should not define other metadata keys", () => {
    const metadataMessage = Reflect.getMetadata("numberMessage", TestClass.prototype, "age");
    const metadataValue = Reflect.getMetadata("fieldValue", TestClass.prototype, "age");
