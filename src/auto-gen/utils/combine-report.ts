...
function generateSummary(codedTests: any[], failedTests: any[], passed200: number, passed201: number) {
    return {
        statusCodes: {
...
async function combineReports(className: string) {
    ...
    const summary = generateSummary(combinedCodedTest, combinedFailedTests, totalPassed200, totalPassed201);
