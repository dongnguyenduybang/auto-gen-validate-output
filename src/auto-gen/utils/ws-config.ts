  ...
  halome: {
    v3: {
      ...
      user: {
        ...
        CLEAR_USER_VISITED_PROFILE_NOTIFICATION:
          'com.halome.user.v3.profile.clear_user_visited_profile_notifications',
        DECORATOR_AVATAR_REMOVED:
          'com.halome.user.v3.profile.decorated_avatar_removed',
        DECORATOR_AVATAR_UPLOADED:
          'com.halome.user.v3.profile.decorated_avatar_uploaded',
        RINGBACK_TONE_CREATED:
          'com.halome.user.v3.profile.ringback_tone_created',
        RINGBACK_TONE_DELETED:
          'com.halome.user.v3.profile.ringback_tone_deleted',
        RINGBACK_TONE_RENAMED:
          'com.halome.user.v3.profile.ringback_tone_renamed',
        RINGBACK_TONE_SELECTED:
          'com.halome.user.v3.profile.ringback_tone_selected',
        ...
        USER_DISPLAY_NAME_UPDATED:
          'com.halome.user.v3.profile.display_name_updated',
        USER_EMAIL_UPDATED: 'com.halome.user.v3.profile.email_updated',
        USER_GLOBAL_MEDIA_PERMISSION_SETTING_UPDATED:
          'com.halome.user.v3.setting.global_media_permission_setting_updated',
        USER_PHONE_UPDATED: 'com.halome.user.v3.profile.phone_updated',
        USER_PRIVACY_DATA_SYNC: 'com.halome.user.v3.private_data_sync',
        USER_SCOPE_FOR_CALL_UPDATED:
          'com.halome.user.v3.setting.user_scope_for_call_updated',
        USER_SCOPE_FOR_MESSAGE_UPDATED:
          'com.halome.user.v3.setting.user_scope_for_message_updated',
        ...
        USER_VISITED_PROFILE_DELETED:
          'com.halome.user.v3.profile.visited_profile_deleted',
      ...
      notification: {
        CALL_NOTIFICATION_CREATED:
          'com.halome.notification.v3.call_notification.created',
        CALL_NOTIFICATION_ENDED:
          'com.halome.notification.v3.call_notification.ended',
        CHANNEL_NOTIFICATION_CREATED:
          'com.halome.notification.v3.channel_notification.created',
        DEVICE_NOTIFICATION_CREATED:
          'com.halome.notification.v3.device_notification.created',
        REVOKE_CHANNELS_NOTIFICATION_PUSHED:
          'com.halome.notification.v3.revoke_channels_notification.pushed',
        REVOKE_MESSAGES_NOTIFICATION_PUSHED:
          'com.halome.notification.v3.revoke_messages_notification.pushed',
        USER_BADGE_COUNT_UPDATED:
          'com.halome.notification.v3.badge_count.updated',
        USER_GLOBAL_NOTIFICATION_STATUS_UPDATED:
          'com.halome.notification.v3.user_global_notification_status.updated',
        USER_NOTIFICATION_CREATED:
          'com.halome.notification.v3.user_notification.created',
      },
      iam: {},
      fs: {
      ...
      chat: {
        ...
        ALL_USER_MESSAGE_DELETED:
          'com.halome.chat.v3.all_user_messages.deleted',
        CHANNEL_AVATAR_UPDATED: 'com.halome.chat.v3.channel.avatar_updated',
        CHANNEL_AVATAR_UPLOAD_FAILED:
          'com.halome.chat.v3.channel.avatar_upload_failed',
        CHANNEL_CREATED: 'com.halome.chat.v3.channel.created',
        CHANNEL_CREATION_COMPLETED:
          'com.halome.chat.v3.channel.creation_completed',
        ...
        DM_CHANNEL_CREATION_COMPLETED:
          'com.halome.chat.v3.dm_channel.creation_completed',
        DM_CHANNEL_MEDIA_PERMISSION_SETTING_UPDATED:
          'com.halome.chat.v3.dm_channel.media_permission_setting_updated',
        FRIEND_REMOVED: 'com.halome.chat.v3.friend.unfriended',
        INCOMING_FRIEND_REQUEST_ACCEPTED:
          'com.halome.chat.v3.incoming_friend_request.accepted',
        INCOMING_FRIEND_REQUEST_CANCELED:
          'com.halome.chat.v3.incoming_friend_request.canceled',
        INCOMING_FRIEND_REQUEST_CREATED:
          'com.halome.chat.v3.incoming_friend_request.created',
        INCOMING_FRIEND_REQUEST_DELETED:
          'com.halome.chat.v3.incoming_friend_request.deleted',
        INCOMING_MESSAGE_REQUEST_ACCEPTED:
          'com.halome.chat.v3.incoming_message_request.accepted',
        INCOMING_MESSAGE_REQUEST_CREATED:
          'com.halome.chat.v3.incoming_message_request.created',
        MARK_ALL_CHANNELS_AS_READ:
          'com.halome.chat.v3.channel.mark-all-as-read',
        ...
        OUTGOING_FRIEND_REQUEST_ACCEPTED:
          'com.halome.chat.v3.outgoing_friend_request.accepted',
        OUTGOING_FRIEND_REQUEST_CANCELED:
          'com.halome.chat.v3.outgoing_friend_request.canceled',
        OUTGOING_FRIEND_REQUEST_CREATED:
          'com.halome.chat.v3.outgoing_friend_request.created',
        OUTGOING_FRIEND_REQUEST_DELETED:
          'com.halome.chat.v3.outgoing_friend_request.deleted',
        ...
        USER_UNREAD_MESSAGE_UPDATED:
          'com.halome.chat.v3.unread_messages.updated',
        WORKSPACE_CREATED: 'com.halome.chat.v3.workspace.created',
        WORKSPACE_CREATION_COMPLETED:
          'com.halome.chat.v3.workspace.creation_completed',
        WORKSPACE_CREATION_FAILED:
          'com.halome.chat.v3.workspace.creation_failed',
      },
      call: {
