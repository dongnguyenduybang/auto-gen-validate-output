    ...
    describe('Testcase for accept-invitation', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = AcceptInvitationRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = AcceptInvitationRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = AcceptInvitationRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = AcceptInvitationRequest.options
