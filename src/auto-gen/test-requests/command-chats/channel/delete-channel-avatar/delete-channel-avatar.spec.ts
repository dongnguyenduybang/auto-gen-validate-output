    ...
    describe('Testcase for delete-channel-avatar', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = DeleteChannelAvatarRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = DeleteChannelAvatarRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = DeleteChannelAvatarRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = DeleteChannelAvatarRequest.options
