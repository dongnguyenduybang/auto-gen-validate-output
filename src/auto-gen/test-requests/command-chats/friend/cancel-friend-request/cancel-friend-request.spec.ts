    ...
    describe('Testcase for cancel-friend-request', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = CancelFriendRequestRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = CancelFriendRequestRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = CancelFriendRequestRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = CancelFriendRequestRequest.options
