    ...
    describe('Testcase for accept-friend-request', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = AcceptFriendRequestRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = AcceptFriendRequestRequest.options[0]?.beforeEach || [];
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = AcceptFriendRequestRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = AcceptFriendRequestRequest.options[0]?.afterAll || [];
