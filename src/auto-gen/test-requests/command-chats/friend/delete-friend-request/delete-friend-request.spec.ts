    ...
    describe('Testcase for delete-friend-request', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = DeleteFriendRequestRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = DeleteFriendRequestRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = DeleteFriendRequestRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = DeleteFriendRequestRequest.options
