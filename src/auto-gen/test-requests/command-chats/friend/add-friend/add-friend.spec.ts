    ...
    describe('Testcase for add-friend', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = AddFriendRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = AddFriendRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = AddFriendRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = AddFriendRequest.options
