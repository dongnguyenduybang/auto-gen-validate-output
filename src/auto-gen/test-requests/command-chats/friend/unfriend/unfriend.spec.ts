    ...
    describe('Testcase for unfriend', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = UnfriendRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = UnfriendRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = UnfriendRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = UnfriendRequest.options
