    ...
    import { LeaveChannelRequest } from '././leave-channel.request';
    describe('Testcase for leave-channel', () => {
        let totalTests = 0;
        let allSteps = [];
        let failedTests: any[] = [];
        let codedTest: any[] = [];
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = LeaveChannelRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = LeaveChannelRequest.options[0]?.beforeEach || [];
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #5 should return errors ["Could not resolve permission type"] when body {"workspaceId":123,"channelId":"invalid_value"}', async () => {
    testNumber = 5;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #6 should return errors [] when body {"workspaceId":"0","channelId":"{{channelId}}"}', async () => {
    testNumber = 6;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #7 should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":123}', async () => {
    testNumber = 7;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #8 should return errors ["Unsupported permission type"] when body {"workspaceId":"0"}', async () => {
    testNumber = 8;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #9 should return errors ["Could not resolve permission type"] when body {"workspaceId":"0","channelId":""}', async () => {
    testNumber = 9;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #10 should return errors ["Invalid channel"] when body {"workspaceId":"0","channelId":"invalid_value"}', async () => {
    testNumber = 10;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #11 should return errors ["Could not resolve permission type"] when body {"channelId":"{{channelId}}"}', async () => {
    testNumber = 11;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #12 should return errors ["Could not resolve permission type"] when body {"channelId":123}', async () => {
    testNumber = 12;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #13 should return errors ["Could not resolve permission type"] when body {}', async () => {
    testNumber = 13;
    totalTests++;
    const payloadObj = {};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #14 should return errors ["Could not resolve permission type"] when body {"channelId":""}', async () => {
    testNumber = 14;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #15 should return errors ["Could not resolve permission type"] when body {"channelId":"invalid_value"}', async () => {
    testNumber = 15;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #16 should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"{{channelId}}"}', async () => {
    testNumber = 16;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #17 should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":123}', async () => {
    testNumber = 17;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #18 should return errors ["Could not resolve permission type"] when body {"workspaceId":""}', async () => {
    testNumber = 18;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #19 should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":""}', async () => {
    testNumber = 19;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #20 should return errors ["Could not resolve permission type"] when body {"workspaceId":"","channelId":"invalid_value"}', async () => {
    testNumber = 20;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #21 should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"{{channelId}}"}', async () => {
    testNumber = 21;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #22 should return errors ["Could not resolve permission type"] when body {"workspaceId":"invalid_value","channelId":123}', async () => {
    testNumber = 22;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #23 should return errors ["Unsupported permission type"] when body {"workspaceId":"invalid_value"}', async () => {
    testNumber = 23;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #24 should return errors ["Could not resolve permission type"] when body {"workspaceId":"invalid_value","channelId":""}', async () => {
    testNumber = 24;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #25 should return errors ["Invalid channel"] when body {"workspaceId":"invalid_value","channelId":"invalid_value"}', async () => {
    testNumber = 25;
    totalTests++;
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = LeaveChannelRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = LeaveChannelRequest.options[0]?.afterAll || [];
          ...
          const fileName = 'leave-channel' + (chunkNumber ? `-chunk-undefined` : '') + '.result.json';
          const filePath = path.join(reportDir, fileName);
          fs.writeFileSync(filePath, JSON.stringify(testResult, null, 2), 'utf-8');

          console.log(`📝 Saved result for leave-channel chunk single to ${filePath}`);
    });
        })
