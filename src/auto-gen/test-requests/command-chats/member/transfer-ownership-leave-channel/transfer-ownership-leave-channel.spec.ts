    ...
    describe('Testcase for transfer-ownership-leave-channel', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = TransferOwnershipLeaveChannelRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = TransferOwnershipLeaveChannelRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = TransferOwnershipLeaveChannelRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = TransferOwnershipLeaveChannelRequest.options
