    ...
    describe('Testcase for transfer-ownership', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = TransferOwnershipRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = TransferOwnershipRequest.options
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = TransferOwnershipRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = TransferOwnershipRequest.options
