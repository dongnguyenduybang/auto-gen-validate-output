    ...
    describe('Testcase for assign-as-admin', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = AssignAsAdminRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = AssignAsAdminRequest.options
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = AssignAsAdminRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = AssignAsAdminRequest.options
