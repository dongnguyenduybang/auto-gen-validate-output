    ...
    describe('Testcase for ban-from-channel', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = BanFromChannelRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = BanFromChannelRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = BanFromChannelRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = BanFromChannelRequest.options
