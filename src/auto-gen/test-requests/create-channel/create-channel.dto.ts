import { ChannelTypeEnum, ErrorMessage, ReportCategory } from "../../enums";
import { IsDefined, IsEnum, IsInvalid, IsNotEmpty, IsString, MinLength, MaxLength, IsOptional, ValidIf } from "../../decorator";
