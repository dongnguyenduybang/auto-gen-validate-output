    ...
    describe('Testcase for mark-as-read', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = MarkAsReadRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = MarkAsReadRequest.options
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = MarkAsReadRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = MarkAsReadRequest.options
