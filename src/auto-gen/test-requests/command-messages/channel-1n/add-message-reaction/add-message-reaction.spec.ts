    ...
    describe('Testcase for add-message-reaction', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = AddMessageReactionRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = AddMessageReactionRequest.options[0]?.beforeEach || [];
    ...
    testNumber = 1;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"};
    ...
    try {
        const response = await resolveCallAPI(
            ...
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
    ...
    testNumber = 2;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":123,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 3;
    totalTests++;
    const payloadObj = {"workspaceId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 4;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 5;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":null,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 6;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 7;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":123,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 8;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 9;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":"","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 10;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":null,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 11;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 12;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 15;
    totalTests++;
    const payloadObj = {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":123,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 17;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 18;
    totalTests++;
    const payloadObj = {"workspaceId":"0","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 20;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 21;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 22;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 23;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":"🚀"},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 25;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 26;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 27;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 30;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 31;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 32;
    totalTests++;
    const payloadObj = {"channelId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 34;
    totalTests++;
    const payloadObj = {"channelId":"","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 35;
    totalTests++;
    const payloadObj = {"channelId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 36;
    totalTests++;
    const payloadObj = {"channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 37;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 39;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 40;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 41;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 42;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 45;
    totalTests++;
    const payloadObj = {"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 47;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":123,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 48;
    totalTests++;
    const payloadObj = {"workspaceId":"","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 50;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":null,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 51;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 52;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"{{channelId}}","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":123,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 53;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"{{channelId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":"","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 55;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"{{channelId}}","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":null,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 56;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 57;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 60;
    totalTests++;
    const payloadObj = {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 61;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 62;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":123,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 63;
    totalTests++;
    const payloadObj = {"workspaceId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 64;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 65;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":null,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 66;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 67;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":123,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 68;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 69;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":"","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 70;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":null,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 71;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 72;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 75;
    totalTests++;
    const payloadObj = {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":null,"channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 76;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 77;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":123,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":123,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 78;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unsupported permission type"].sort();
    ...
    testNumber = 79;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 80;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":null,"messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":null,"messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 81;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"invalid_value","messageId":"{{messageId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 82;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":123,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 83;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 84;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 85;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":null,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 86;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 87;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 90;
    totalTests++;
    const payloadObj = {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"invalid_value","channelId":"{{channelId}}","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 91;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 93;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 94;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 95;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":123,"messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 96;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 99;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":123,"messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 104;
    totalTests++;
    const payloadObj = {"workspaceId":"0","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 105;
    totalTests++;
    const payloadObj = {"workspaceId":"0","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 108;
    totalTests++;
    const payloadObj = {"workspaceId":"0","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 109;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 112;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 113;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 114;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 117;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 118;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 120;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 121;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 122;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":null,"messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 123;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 126;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":null,"messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    testNumber = 127;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":123,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":123,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 128;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 129;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":"","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":"","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 130;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":null,"emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":null,"emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 131;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":"invalid_ULID","emoji":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":"invalid_ULID","emoji":"🚀"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 132;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 135;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"invalid_value","messageId":"{{messageId}}","emoji":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Invalid channel"].sort();
    ...
    testNumber = 136;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":123},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 139;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":123,"emoji":null},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 140;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 143;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    testNumber = 144;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":123},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 147;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"","emoji":null},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 148;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":123},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 151;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":null,"emoji":null},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 152;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":123},
            contextData
        );
        const data = response.data;
    ...
    testNumber = 155;
    totalTests++;
    const payloadObj = {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'addMessageReaction',
            {"x-session-token":"{{token}}"},
            {"workspaceId":"0","channelId":"{{channelId}}","messageId":"invalid_ULID","emoji":null},
            contextData
        );
        const data = response.data;
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = AddMessageReactionRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = AddMessageReactionRequest.options[0]?.afterAll || [];
          ...
          const fileName = 'add-message-reaction' + (chunkNumber ? `-chunk-undefined` : '') + '.result.json';
          const filePath = path.join(reportDir, fileName);
          fs.writeFileSync(filePath, JSON.stringify(testResult, null, 2), 'utf-8');

          console.log(`📝 Saved result for add-message-reaction chunk single to ${filePath}`);
    });
        })
