...
import { IsArray, Type, ValidateNested, IsDefined, IsNotEmpty, IsNumber, IsString, IsNotNull, IsInvalid, IsEnum, MinLength, IsObject, isValidURL } from '../../../../decorator';
...
export class SendDmMessageMediaDTO {
