    ...
    describe('Testcase for forward-dm-message-channel', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = ForwardDmMessageChannelRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = ForwardDmMessageChannelRequest.options[0]?.beforeEach || [];
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #6 should return errors ["Could not resolve permission type"] when body {"userId":123,"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]}', async () => {
    testNumber = 6;
    totalTests++;
    const payloadObj = {"userId":123,"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'forwardDmMessageChannel',
            {"x-session-token":"{{token}}"},
            {"userId":123,"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #16 should return errors ["Code: 404. Message: Data not found. Details: Data not found."] when body {"userId":"{{userId1}}","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]}', async () => {
    testNumber = 16;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'forwardDmMessageChannel',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]},
            contextData
        );
        const data = response.data;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #26 should return errors ["Could not resolve permission type"] when body {"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]}', async () => {
    testNumber = 26;
    totalTests++;
    const payloadObj = {"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'forwardDmMessageChannel',
            {"x-session-token":"{{token}}"},
            {"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #36 should return errors ["Could not resolve permission type"] when body {"userId":"","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]}', async () => {
    testNumber = 36;
    totalTests++;
    const payloadObj = {"userId":"","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'forwardDmMessageChannel',
            {"x-session-token":"{{token}}"},
            {"userId":"","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #46 should return errors ["Could not resolve permission type"] when body {"userId":null,"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]}', async () => {
    testNumber = 46;
    totalTests++;
    const payloadObj = {"userId":null,"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'forwardDmMessageChannel',
            {"x-session-token":"{{token}}"},
            {"userId":null,"originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #56 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]}', async () => {
    testNumber = 56;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'forwardDmMessageChannel',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","originalMessageIds":["01JYQMRKM2T75WY1BHSB9DTY6N"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = ForwardDmMessageChannelRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = ForwardDmMessageChannelRequest.options[0]?.afterAll || [];
