    ...
    describe('Testcase for delete-dm-messages-for-everyone', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = DeleteDmMessagesForEveryoneRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = DeleteDmMessagesForEveryoneRequest.options[0]?.beforeEach || [];
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #6 should return errors ["Could not resolve permission type"] when body {"userId":123,"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]}', async () => {
    testNumber = 6;
    totalTests++;
    const payloadObj = {"userId":123,"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'deleteDmMessagesForEveryone',
            {"x-session-token":"{{token}}"},
            {"userId":123,"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #15 should return errors ["Messages not exist"] when body {"userId":"{{userId1}}","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]}', async () => {
    testNumber = 15;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'deleteDmMessagesForEveryone',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]},
            contextData
        );
        const data = response.data;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #24 should return errors ["Could not resolve permission type"] when body {"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]}', async () => {
    testNumber = 24;
    totalTests++;
    const payloadObj = {"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'deleteDmMessagesForEveryone',
            {"x-session-token":"{{token}}"},
            {"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #33 should return errors ["Could not resolve permission type"] when body {"userId":"","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]}', async () => {
    testNumber = 33;
    totalTests++;
    const payloadObj = {"userId":"","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'deleteDmMessagesForEveryone',
            {"x-session-token":"{{token}}"},
            {"userId":"","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #42 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]}', async () => {
    testNumber = 42;
    totalTests++;
    const payloadObj = {"userId":null,"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'deleteDmMessagesForEveryone',
            {"x-session-token":"{{token}}"},
            {"userId":null,"messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #51 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]}', async () => {
    testNumber = 51;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'deleteDmMessagesForEveryone',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","messageIds":["01JYQMRJXSW25C9EHXDF8407ZD"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = DeleteDmMessagesForEveryoneRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = DeleteDmMessagesForEveryoneRequest.options[0]?.afterAll || [];
