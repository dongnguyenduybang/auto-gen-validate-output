    ...
    describe('Testcase for revoke-dm-message-reaction', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = RevokeDmMessageReactionRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = RevokeDmMessageReactionRequest.options[0]?.beforeEach || [];
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = RevokeDmMessageReactionRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = RevokeDmMessageReactionRequest.options[0]?.afterAll || [];
