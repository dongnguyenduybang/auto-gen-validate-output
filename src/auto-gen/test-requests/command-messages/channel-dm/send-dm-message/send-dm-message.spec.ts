    ...
    describe('Testcase for send-dm-message', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = SendDmMessageRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = SendDmMessageRequest.options
            ...
            it('Test case #46 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"test response send dm message","ref":"ref"}', async () => {
              ...
              try {
                const response = await resolveCallAPI(
                  "sendDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":"invalid_value","content":"test response send dm message","ref":"ref"},
                  contextData
                );
                const data = response.data;
            ...
            it('Test case #52 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"test response send dm message","ref":123}', async () => {
              ...
              try {
                const response = await resolveCallAPI(
                  "sendDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":"invalid_value","content":"test response send dm message","ref":123},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Unauthorized request"].sort();
            ...
            it('Test case #53 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"test response send dm message","ref":""}', async () => {
              ...
              try {
                const response = await resolveCallAPI(
                  "sendDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":"invalid_value","content":"test response send dm message","ref":""},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Unauthorized request"].sort();
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = SendDmMessageRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = SendDmMessageRequest.options
