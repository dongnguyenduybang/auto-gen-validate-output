    ...
    describe('Testcase for send-dm-message', () => {
        ...
        beforeEach(async () => {
          ...
          if (beforeEachSteps.length > 0) {
            ...
            it('Test case #1 should return errors ["Could not resolve permission type"] when body {"userId":123,"content":"send dm message chain update","ref":"ref"}', async () => {
    testNumber = 1;
    totalTests++;
    const payloadObj = {"userId":123,"content":"send dm message chain update","ref":"ref"};
    ...
    try {
        const response = await resolveCallAPI(
            ...
            {"userId":123,"content":"send dm message chain update","ref":"ref"},
            contextData
        );
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #7 should return errors ["Could not resolve permission type"] when body {"userId":123,"content":"send dm message chain update","ref":123}', async () => {
    testNumber = 7;
    totalTests++;
    const payloadObj = {"userId":123,"content":"send dm message chain update","ref":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":123,"content":"send dm message chain update","ref":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #8 should return errors ["Could not resolve permission type"] when body {"userId":123,"content":"send dm message chain update","ref":""}', async () => {
    testNumber = 8;
    totalTests++;
    const payloadObj = {"userId":123,"content":"send dm message chain update","ref":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":123,"content":"send dm message chain update","ref":""},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #9 should return errors ["Could not resolve permission type"] when body {"userId":123,"content":"send dm message chain update"}', async () => {
    testNumber = 9;
    totalTests++;
    const payloadObj = {"userId":123,"content":"send dm message chain update"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":123,"content":"send dm message chain update"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #10 should return errors ["Could not resolve permission type"] when body {"userId":123,"content":"send dm message chain update","ref":null}', async () => {
    testNumber = 10;
    totalTests++;
    const payloadObj = {"userId":123,"content":"send dm message chain update","ref":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":123,"content":"send dm message chain update","ref":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #11 should return errors [] when body {"userId":"{{userId1}}","content":"send dm message chain update","ref":"ref"}', async () => {
    testNumber = 11;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","content":"send dm message chain update","ref":"ref"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","content":"send dm message chain update","ref":"ref"},
            contextData
        );
        const data = response.data;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #17 should return errors ["ref expected string,received number"] when body {"userId":"{{userId1}}","content":"send dm message chain update","ref":123}', async () => {
    testNumber = 17;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","content":"send dm message chain update","ref":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","content":"send dm message chain update","ref":123},
            contextData
        );
        const data = response.data;
        ...
        failedTests.push({
            ...
            it('Test case #18 should return errors ["ref should not be empty","ref string must contain at least 1 character(s)"] when body {"userId":"{{userId1}}","content":"send dm message chain update","ref":""}', async () => {
    testNumber = 18;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","content":"send dm message chain update","ref":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","content":"send dm message chain update","ref":""},
            contextData
        );
        const data = response.data;
        ...
        failedTests.push({
            ...
            it('Test case #19 should return errors ["ref required"] when body {"userId":"{{userId1}}","content":"send dm message chain update"}', async () => {
    testNumber = 19;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","content":"send dm message chain update"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","content":"send dm message chain update"},
            contextData
        );
        const data = response.data;
        ...
        failedTests.push({
            ...
            it('Test case #20 should return errors ["ref expected string,received null"] when body {"userId":"{{userId1}}","content":"send dm message chain update","ref":null}', async () => {
    testNumber = 20;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","content":"send dm message chain update","ref":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","content":"send dm message chain update","ref":null},
            contextData
        );
        const data = response.data;
        ...
        failedTests.push({
            ...
            it('Test case #21 should return errors ["Could not resolve permission type"] when body {"content":"send dm message chain update","ref":"ref"}', async () => {
    testNumber = 21;
    totalTests++;
    const payloadObj = {"content":"send dm message chain update","ref":"ref"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"content":"send dm message chain update","ref":"ref"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #27 should return errors ["Could not resolve permission type"] when body {"content":"send dm message chain update","ref":123}', async () => {
    testNumber = 27;
    totalTests++;
    const payloadObj = {"content":"send dm message chain update","ref":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"content":"send dm message chain update","ref":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #28 should return errors ["Could not resolve permission type"] when body {"content":"send dm message chain update","ref":""}', async () => {
    testNumber = 28;
    totalTests++;
    const payloadObj = {"content":"send dm message chain update","ref":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"content":"send dm message chain update","ref":""},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #29 should return errors ["Could not resolve permission type"] when body {"content":"send dm message chain update"}', async () => {
    testNumber = 29;
    totalTests++;
    const payloadObj = {"content":"send dm message chain update"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #30 should return errors ["Could not resolve permission type"] when body {"content":"send dm message chain update","ref":null}', async () => {
    testNumber = 30;
    totalTests++;
    const payloadObj = {"content":"send dm message chain update","ref":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"content":"send dm message chain update","ref":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #31 should return errors ["Could not resolve permission type"] when body {"userId":"","content":"send dm message chain update","ref":"ref"}', async () => {
    testNumber = 31;
    totalTests++;
    const payloadObj = {"userId":"","content":"send dm message chain update","ref":"ref"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"","content":"send dm message chain update","ref":"ref"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #37 should return errors ["Could not resolve permission type"] when body {"userId":"","content":"send dm message chain update","ref":123}', async () => {
    testNumber = 37;
    totalTests++;
    const payloadObj = {"userId":"","content":"send dm message chain update","ref":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"","content":"send dm message chain update","ref":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #38 should return errors ["Could not resolve permission type"] when body {"userId":"","content":"send dm message chain update","ref":""}', async () => {
    testNumber = 38;
    totalTests++;
    const payloadObj = {"userId":"","content":"send dm message chain update","ref":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"","content":"send dm message chain update","ref":""},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #39 should return errors ["Could not resolve permission type"] when body {"userId":"","content":"send dm message chain update"}', async () => {
    testNumber = 39;
    totalTests++;
    const payloadObj = {"userId":"","content":"send dm message chain update"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"","content":"send dm message chain update"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #40 should return errors ["Could not resolve permission type"] when body {"userId":"","content":"send dm message chain update","ref":null}', async () => {
    testNumber = 40;
    totalTests++;
    const payloadObj = {"userId":"","content":"send dm message chain update","ref":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"","content":"send dm message chain update","ref":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #41 should return errors ["Could not resolve permission type"] when body {"userId":null,"content":"send dm message chain update","ref":"ref"}', async () => {
    testNumber = 41;
    totalTests++;
    const payloadObj = {"userId":null,"content":"send dm message chain update","ref":"ref"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":null,"content":"send dm message chain update","ref":"ref"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #47 should return errors ["Could not resolve permission type"] when body {"userId":null,"content":"send dm message chain update","ref":123}', async () => {
    testNumber = 47;
    totalTests++;
    const payloadObj = {"userId":null,"content":"send dm message chain update","ref":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":null,"content":"send dm message chain update","ref":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #48 should return errors ["Could not resolve permission type"] when body {"userId":null,"content":"send dm message chain update","ref":""}', async () => {
    testNumber = 48;
    totalTests++;
    const payloadObj = {"userId":null,"content":"send dm message chain update","ref":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":null,"content":"send dm message chain update","ref":""},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #49 should return errors ["Could not resolve permission type"] when body {"userId":null,"content":"send dm message chain update"}', async () => {
    testNumber = 49;
    totalTests++;
    const payloadObj = {"userId":null,"content":"send dm message chain update"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":null,"content":"send dm message chain update"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #50 should return errors ["Could not resolve permission type"] when body {"userId":null,"content":"send dm message chain update","ref":null}', async () => {
    testNumber = 50;
    totalTests++;
    const payloadObj = {"userId":null,"content":"send dm message chain update","ref":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":null,"content":"send dm message chain update","ref":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #51 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"send dm message chain update","ref":"ref"}', async () => {
    testNumber = 51;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","content":"send dm message chain update","ref":"ref"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","content":"send dm message chain update","ref":"ref"},
            contextData
        );
        const data = response.data;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #57 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"send dm message chain update","ref":123}', async () => {
    testNumber = 57;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","content":"send dm message chain update","ref":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","content":"send dm message chain update","ref":123},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #58 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"send dm message chain update","ref":""}', async () => {
    testNumber = 58;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","content":"send dm message chain update","ref":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","content":"send dm message chain update","ref":""},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #59 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"send dm message chain update"}', async () => {
    testNumber = 59;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","content":"send dm message chain update"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","content":"send dm message chain update"},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #60 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","content":"send dm message chain update","ref":null}', async () => {
    testNumber = 60;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","content":"send dm message chain update","ref":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'sendDmMessage',
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","content":"send dm message chain update","ref":null},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
