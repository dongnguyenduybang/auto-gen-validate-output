    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #6 should return errors ["Could not resolve permission type"] when body {"userId":123,"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]}', async () => {
    testNumber = 6;
    totalTests++;
    const payloadObj = {"userId":123,"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            "deleteDmMessagesOnlyMe",
            {"x-session-token":"{{token}}"},
            {"userId":123,"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #15 should return errors ["Messages not exist"] when body {"userId":"{{userId1}}","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]}', async () => {
    testNumber = 15;
    totalTests++;
    const payloadObj = {"userId":"{{userId1}}","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            "deleteDmMessagesOnlyMe",
            {"x-session-token":"{{token}}"},
            {"userId":"{{userId1}}","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]},
            contextData
        );
        const data = response.data;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #24 should return errors ["Could not resolve permission type"] when body {"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]}', async () => {
    testNumber = 24;
    totalTests++;
    const payloadObj = {"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            "deleteDmMessagesOnlyMe",
            {"x-session-token":"{{token}}"},
            {"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #33 should return errors ["Could not resolve permission type"] when body {"userId":"","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]}', async () => {
    testNumber = 33;
    totalTests++;
    const payloadObj = {"userId":"","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            "deleteDmMessagesOnlyMe",
            {"x-session-token":"{{token}}"},
            {"userId":"","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #42 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]}', async () => {
    testNumber = 42;
    totalTests++;
    const payloadObj = {"userId":null,"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            "deleteDmMessagesOnlyMe",
            {"x-session-token":"{{token}}"},
            {"userId":null,"messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Could not resolve permission type"].sort();
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #51 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]}', async () => {
    testNumber = 51;
    totalTests++;
    const payloadObj = {"userId":"invalid_value","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            "deleteDmMessagesOnlyMe",
            {"x-session-token":"{{token}}"},
            {"userId":"invalid_value","messageIds":["01JY3DC7FCH3KBSTPBRW18WC7Y"]},
            contextData
        );
        const data = response.data;
        const expectJson = ["Unauthorized request"].sort();
