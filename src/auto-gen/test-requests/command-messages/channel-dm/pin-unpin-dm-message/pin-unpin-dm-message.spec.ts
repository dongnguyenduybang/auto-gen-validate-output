    ...
    import { PinUnpinDmMessageRequest } from '././pin-unpin-dm-message.request';
    describe('Testcase for pin-unpin-dm-message', () => {
        let totalTests = 0;
        let allSteps = [];
        let failedTests: any[] = [];
        let codedTest: any[] = [];
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = PinUnpinDmMessageRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = PinUnpinDmMessageRequest.options
          ...
          if (beforeEachSteps.length > 0) {
            ...
            it('Test case #1 should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"{{messageId}}","status":true}', async () => {
              testNumber = 1;
              totalTests++;
              const payloadObj = {"userId":123,"messageId":"{{messageId}}","status":true};
              ...
              try {
                const response = await resolveCallAPI(
                  ...
                  {"userId":123,"messageId":"{{messageId}}","status":true},
                  contextData
                );
            ...
            it('Test case #4 should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"","status":true}', async () => {
              testNumber = 4;
              totalTests++;
            ...
            it('Test case #5 should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":null,"status":true}', async () => {
              testNumber = 5;
              totalTests++;
            ...
            it('Test case #6 should return errors ["Could not resolve permission type"] when body {"userId":123,"messageId":"invalid_ULID","status":true}', async () => {
              testNumber = 6;
              totalTests++;
            ...
            it('Test case #10 should return errors [] when body {"userId":"{{userId1}}","messageId":"{{messageId}}","status":true}', async () => {
              testNumber = 10;
              totalTests++;
              const payloadObj = {"userId":"{{userId1}}","messageId":"{{messageId}}","status":true};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "pinUnpinDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":"{{userId1}}","messageId":"{{messageId}}","status":true},
                  contextData
                );
                const data = response.data;
            ...
            it('Test case #11 should return errors ["messageId expected string,received number"] when body {"userId":"{{userId1}}","messageId":123,"status":true}', async () => {
              testNumber = 11;
              totalTests++;
            ...
            it('Test case #12 should return errors ["messageId required"] when body {"userId":"{{userId1}}","status":true}', async () => {
              testNumber = 12;
              totalTests++;
            ...
            it('Test case #13 should return errors ["messageId should not be empty","messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"","status":true}', async () => {
              testNumber = 13;
              totalTests++;
            ...
            it('Test case #14 should return errors ["messageId expected string,received null"] when body {"userId":"{{userId1}}","messageId":null,"status":true}', async () => {
              testNumber = 14;
              totalTests++;
            ...
            it('Test case #15 should return errors ["messageId invalid ulid"] when body {"userId":"{{userId1}}","messageId":"invalid_ULID","status":true}', async () => {
              testNumber = 15;
              totalTests++;
            ...
            it('Test case #19 should return errors ["Could not resolve permission type"] when body {"messageId":"{{messageId}}","status":true}', async () => {
              testNumber = 19;
              totalTests++;
            ...
            it('Test case #20 should return errors ["Could not resolve permission type"] when body {"messageId":123,"status":true}', async () => {
              testNumber = 20;
              totalTests++;
            ...
            it('Test case #21 should return errors ["Could not resolve permission type"] when body {"status":true}', async () => {
              testNumber = 21;
              totalTests++;
            ...
            it('Test case #22 should return errors ["Could not resolve permission type"] when body {"messageId":"","status":true}', async () => {
              testNumber = 22;
              totalTests++;
            ...
            it('Test case #23 should return errors ["Could not resolve permission type"] when body {"messageId":null,"status":true}', async () => {
              testNumber = 23;
              totalTests++;
            ...
            it('Test case #24 should return errors ["Could not resolve permission type"] when body {"messageId":"invalid_ULID","status":true}', async () => {
              testNumber = 24;
              totalTests++;
            ...
            it('Test case #28 should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"{{messageId}}","status":true}', async () => {
              testNumber = 28;
              totalTests++;
              const payloadObj = {"userId":"","messageId":"{{messageId}}","status":true};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "pinUnpinDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":"","messageId":"{{messageId}}","status":true},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Could not resolve permission type"].sort();
            ...
            it('Test case #29 should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":123,"status":true}', async () => {
              testNumber = 29;
              totalTests++;
            ...
            it('Test case #30 should return errors ["Could not resolve permission type"] when body {"userId":"","status":true}', async () => {
              testNumber = 30;
              totalTests++;
            ...
            it('Test case #31 should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"","status":true}', async () => {
              testNumber = 31;
              totalTests++;
            ...
            it('Test case #32 should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":null,"status":true}', async () => {
              testNumber = 32;
              totalTests++;
            ...
            it('Test case #33 should return errors ["Could not resolve permission type"] when body {"userId":"","messageId":"invalid_ULID","status":true}', async () => {
              testNumber = 33;
              totalTests++;
            ...
            it('Test case #37 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"{{messageId}}","status":true}', async () => {
              testNumber = 37;
              totalTests++;
              const payloadObj = {"userId":null,"messageId":"{{messageId}}","status":true};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "pinUnpinDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":null,"messageId":"{{messageId}}","status":true},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Could not resolve permission type"].sort();
            ...
            it('Test case #38 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":123,"status":true}', async () => {
              testNumber = 38;
              totalTests++;
            ...
            it('Test case #39 should return errors ["Could not resolve permission type"] when body {"userId":null,"status":true}', async () => {
              testNumber = 39;
              totalTests++;
            ...
            it('Test case #40 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"","status":true}', async () => {
              testNumber = 40;
              totalTests++;
            ...
            it('Test case #41 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":null,"status":true}', async () => {
              testNumber = 41;
              totalTests++;
            ...
            it('Test case #42 should return errors ["Could not resolve permission type"] when body {"userId":null,"messageId":"invalid_ULID","status":true}', async () => {
              testNumber = 42;
              totalTests++;
            ...
            it('Test case #46 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"{{messageId}}","status":true}', async () => {
              testNumber = 46;
              totalTests++;
              const payloadObj = {"userId":"invalid_value","messageId":"{{messageId}}","status":true};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "pinUnpinDmMessage",
                  {"x-session-token":"{{token}}"},
                  {"userId":"invalid_value","messageId":"{{messageId}}","status":true},
                  contextData
                );
                const data = response.data;
            ...
            it('Test case #47 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":123,"status":true}', async () => {
              testNumber = 47;
              totalTests++;
            ...
            it('Test case #48 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","status":true}', async () => {
              testNumber = 48;
              totalTests++;
            ...
            it('Test case #49 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"","status":true}', async () => {
              testNumber = 49;
              totalTests++;
            ...
            it('Test case #50 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":null,"status":true}', async () => {
              testNumber = 50;
              totalTests++;
            ...
            it('Test case #51 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","messageId":"invalid_ULID","status":true}', async () => {
              testNumber = 51;
              totalTests++;
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = PinUnpinDmMessageRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = PinUnpinDmMessageRequest.options
          ...
          const testResult: TestResult = {
            ...
            className: 'pin-unpin-dm-message',
            allSteps: allSteps,
  ...
  const fileName = 'pin-unpin-dm-message' + (chunkNumber ? `-chunk-undefined` : '') + '.result.json';
  const filePath = path.join(reportDir, fileName);
  fs.writeFileSync(filePath, JSON.stringify(testResult, null, 2), 'utf-8');

  console.log(`📝 Saved result for pin-unpin-dm-message chunk single to ${filePath}`);
    });
        })
