    ...
    describe('Testcase for mark-dm-as-read', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = MarkDmAsReadRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = MarkDmAsReadRequest.options
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = MarkDmAsReadRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = MarkDmAsReadRequest.options
