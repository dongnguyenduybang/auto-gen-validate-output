        ...
        beforeEach(async () => {
          ...
          if (beforeEachSteps.length > 0) {
            ...
            it('Test case #9 should return errors ["Could not resolve permission type"] when body {"userId":123,"reportCategory":0,"reportReason":"","pretendingTo":0}', async () => {
              testNumber = 9;
              totalTests++;
              const payloadObj = {"userId":123,"reportCategory":0,"reportReason":"","pretendingTo":0};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "reportUser",
                  {"x-session-token":"{{token}}"},
                  {"userId":123,"reportCategory":0,"reportReason":"","pretendingTo":0},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Could not resolve permission type"].sort();
            ...
            it('Test case #13 should return errors ["Could not resolve permission type"] when body {"userId":123,"reportCategory":0,"reportReason":"report user"}', async () => {
              testNumber = 13;
              totalTests++;
              const payloadObj = {"userId":123,"reportCategory":0,"reportReason":"report user"};
              resolvedData = resolveVariables(payloadObj, globalContext);
            ...
            it('Test case #22 should return errors ["reportReason string must contain at most 255 character(s)"] when body {"userId":"{{userId1}}","reportCategory":0,"reportReason":"","pretendingTo":0}', async () => {
              testNumber = 22;
              totalTests++;
              const payloadObj = {"userId":"{{userId1}}","reportCategory":0,"reportReason":"","pretendingTo":0};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "reportUser",
                  {"x-session-token":"{{token}}"},
                  {"userId":"{{userId1}}","reportCategory":0,"reportReason":"","pretendingTo":0},
                  contextData
                );
                const data = response.data;
            ...
            it('Test case #26 should return errors [] when body {"userId":"{{userId1}}","reportCategory":0,"reportReason":"report user"}', async () => {
              testNumber = 26;
              totalTests++;
              const payloadObj = {"userId":"{{userId1}}","reportCategory":0,"reportReason":"report user"};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "reportUser",
                  {"x-session-token":"{{token}}"},
                  {"userId":"{{userId1}}","reportCategory":0,"reportReason":"report user"},
                  contextData
                );
                const data = response.data;
                const expectJson = [].sort();
            ...
            it('Test case #35 should return errors ["Could not resolve permission type"] when body {"reportCategory":0,"reportReason":"","pretendingTo":0}', async () => {
              testNumber = 35;
              totalTests++;
              const payloadObj = {"reportCategory":0,"reportReason":"","pretendingTo":0};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "reportUser",
                  {"x-session-token":"{{token}}"},
                  {"reportCategory":0,"reportReason":"","pretendingTo":0},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Could not resolve permission type"].sort();
            ...
            it('Test case #48 should return errors ["Could not resolve permission type"] when body {"userId":"","reportCategory":0,"reportReason":"","pretendingTo":0}', async () => {
              testNumber = 48;
              totalTests++;
              const payloadObj = {"userId":"","reportCategory":0,"reportReason":"","pretendingTo":0};
              resolvedData = resolveVariables(payloadObj, globalContext);
            ...
            it('Test case #52 should return errors ["Could not resolve permission type"] when body {"userId":"","reportCategory":0,"reportReason":"report user"}', async () => {
              testNumber = 52;
              totalTests++;
              const payloadObj = {"userId":"","reportCategory":0,"reportReason":"report user"};
              resolvedData = resolveVariables(payloadObj, globalContext);
            ...
            it('Test case #61 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","reportCategory":0,"reportReason":"","pretendingTo":0}', async () => {
              testNumber = 61;
              totalTests++;
              const payloadObj = {"userId":"invalid_value","reportCategory":0,"reportReason":"","pretendingTo":0};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "reportUser",
                  {"x-session-token":"{{token}}"},
                  {"userId":"invalid_value","reportCategory":0,"reportReason":"","pretendingTo":0},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Unauthorized request"].sort();
            ...
            it('Test case #65 should return errors ["Unauthorized request"] when body {"userId":"invalid_value","reportCategory":0,"reportReason":"report user"}', async () => {
              testNumber = 65;
              totalTests++;
              const payloadObj = {"userId":"invalid_value","reportCategory":0,"reportReason":"report user"};
              resolvedData = resolveVariables(payloadObj, globalContext);
              ...
              try {
                const response = await resolveCallAPI(
                  "reportUser",
                  {"x-session-token":"{{token}}"},
                  {"userId":"invalid_value","reportCategory":0,"reportReason":"report user"},
                  contextData
                );
                const data = response.data;
                const expectJson = ["Unauthorized request"].sort();
            ...
            it('Test case #102 should return errors ["reportReason expected string,received number"] when body {"userId":"{{userId1}}","reportCategory":0,"reportReason":123}', async () => {
              testNumber = 102;
              totalTests++;
              const payloadObj = {"userId":"{{userId1}}","reportCategory":0,"reportReason":123};
              resolvedData = resolveVariables(payloadObj, globalContext);
            ...
            it('Test case #104 should return errors ["reportReason should not be empty","reportReason string must contain at least 1 character(s)"] when body {"userId":"{{userId1}}","reportCategory":0,"reportReason":""}', async () => {
              testNumber = 104;
              totalTests++;
              const payloadObj = {"userId":"{{userId1}}","reportCategory":0,"reportReason":""};
              resolvedData = resolveVariables(payloadObj, globalContext);
