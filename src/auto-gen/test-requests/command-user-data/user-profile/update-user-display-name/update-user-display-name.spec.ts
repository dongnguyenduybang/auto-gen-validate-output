    ...
    describe('Testcase for update-user-display-name', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = UpdateUserDisplayNameRequest.options
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = UpdateUserDisplayNameRequest.options
          ...
          if (beforeEachSteps.length > 0) {
            ...
            it('Test case #1 should return errors ["displayName expected string,received number"] when body {"displayName":123}', async () => {
    testNumber = 1;
    totalTests++;
    const payloadObj = {"displayName":123};
    ...
    try {
        ...
        const expectJson = ["displayName expected string, received number"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #2 should return errors [] when body {"displayName":"ABCDEF"}', async () => {
    testNumber = 2;
    totalTests++;
    const payloadObj = {"displayName":"ABCDEF"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #3 should return errors ["displayName string must contain at most 50 character(s)"] when body {"displayName":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}', async () => {
    testNumber = 3;
    totalTests++;
    const payloadObj = {"displayName":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        const data = response.data;
        const expectJson = ["displayName string must contain at most 50 character(s)"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #4 should return errors ["displayName required"] when body {}', async () => {
    testNumber = 4;
    totalTests++;
    const payloadObj = {};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        const data = response.data;
        const expectJson = ["displayName required"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #5 should return errors ["displayName should not be empty"] when body {"displayName":""}', async () => {
    testNumber = 5;
    totalTests++;
    const payloadObj = {"displayName":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        const data = response.data;
        const expectJson = ["displayName should not be empty"].sort();
        ...
        failedTests.push({
            ...
            it('Test case #6 should return errors ["displayName expected string,received null"] when body {"displayName":null}', async () => {
    testNumber = 6;
    totalTests++;
    const payloadObj = {"displayName":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        const data = response.data;
        const expectJson = ["displayName expected string, received null"].sort();
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = UpdateUserDisplayNameRequest.options
         ...
         afterAll(async () => {
          const afterAllSteps = UpdateUserDisplayNameRequest.options
          ...
          const testResult: TestResult = {
            ...
            className: 'update-user-display-name',
            allSteps: allSteps,
  ...
  const fileName = 'update-user-display-name' + (chunkNumber ? `-chunk-undefined` : '') + '.result.json';
  const filePath = path.join(reportDir, fileName);
  fs.writeFileSync(filePath, JSON.stringify(testResult, null, 2), 'utf-8');

  console.log(`📝 Saved result for update-user-display-name chunk single to ${filePath}`);
    });
        })
