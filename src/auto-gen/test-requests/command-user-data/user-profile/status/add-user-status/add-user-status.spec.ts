    ...
    describe('Testcase for add-user-status', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = AddUserStatusRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = AddUserStatusRequest.options[0]?.beforeEach || [];
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = AddUserStatusRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = AddUserStatusRequest.options[0]?.afterAll || [];
