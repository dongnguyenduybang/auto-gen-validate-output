...
describe('Testcase for add-user-status', () => {
  ...
  beforeAll(async () => {
    ...
    const beforeAllSteps =
      AddUserStatusRequest.options?.find((option) => option.beforeAll)
        ?.beforeAll || [];
  ...
  beforeEach(async () => {
    ...
    const beforeEachSteps =
      AddUserStatusRequest.options?.find((option) => option.beforeEach)
        ?.beforeEach || [];
  ...
  it('Test case #5 should return errors ["content expected string,received number","status expected string,received null"] when body {"content":123,"status":null,"expireAfterTime":1}', async () => {
    ...
    try {
      ...
      const expectJson = [
        'content expected string, received number',
        'status expected string, received null',
      ].sort();
  ...
  it('Test case #6 should return errors ["content expected string,received number","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'invalid_enum_value\'"] when body {"content":123,"status":"🚀","expireAfterTime":"invalid_enum_value"}', async () => {
    ...
    const payloadObj = {
      content: 123,
      status: '🚀',
      expireAfterTime: 'invalid_enum_value',
    };
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
      ...
      const expectJson = [
        'content expected string, received number',
        "expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99, received 'invalid_enum_value'",
      ].sort();
  ...
  it('Test case #7 should return errors ["content expected string,received number","expireAfterTime required","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'undefined\'"] when body {"content":123,"status":"🚀"}', async () => {
    ...
    try {
      ...
      const expectJson = [
        'content expected string, received number',
        'expireAfterTime required',
        "expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99, received 'undefined'",
      ].sort();
  ...
  it('Test case #8 should return errors ["content expected string,received number","expireAfterTime should not be empty","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'\'"] when body {"content":123,"status":"🚀","expireAfterTime":""}', async () => {
    ...
    try {
      ...
      const expectJson = [
        'content expected string, received number',
        'expireAfterTime should not be empty',
        "expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99, received ''",
      ].sort();
  ...
  it('Test case #9 should return errors ["content expected string,received number","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'null\'"] when body {"content":123,"status":"🚀","expireAfterTime":null}', async () => {
    ...
    try {
      ...
      const expectJson = [
        'content expected string, received number',
        "expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99, received 'null'",
      ].sort();
  ...
  it('Test case #19 should return errors ["content string must contain at most 50 character(s)"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀","expireAfterTime":1}', async () => {
    testNumber = 19;
    totalTests++;
    const payloadObj = {
    ...
    try {
      ...
      const data = response.data;
      const expectJson = [
        'content string must contain at most 50 character(s)',
      ].sort();
  ...
  it('Test case #20 should return errors ["content string must contain at most 50 character(s)","status expected string,received number"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":123,"expireAfterTime":1}', async () => {
    testNumber = 20;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #21 should return errors ["content string must contain at most 50 character(s)","status only accepts 1 emoji"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀🚀","expireAfterTime":1}', async () => {
    testNumber = 21;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #22 should return errors ["content string must contain at most 50 character(s)","status invalid emoji","status only accepts 1 emoji"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"","expireAfterTime":1}', async () => {
    testNumber = 22;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #23 should return errors ["content string must contain at most 50 character(s)","status expected string,received null"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":null,"expireAfterTime":1}', async () => {
    testNumber = 23;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #24 should return errors ["content string must contain at most 50 character(s)","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'invalid_enum_value\'"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀","expireAfterTime":"invalid_enum_value"}', async () => {
    testNumber = 24;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #25 should return errors ["content string must contain at most 50 character(s)","expireAfterTime required","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'undefined\'"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀"}', async () => {
    testNumber = 25;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #26 should return errors ["content string must contain at most 50 character(s)","expireAfterTime should not be empty","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'\'"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀","expireAfterTime":""}', async () => {
    testNumber = 26;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #27 should return errors ["content string must contain at most 50 character(s)","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'null\'"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀","expireAfterTime":null}', async () => {
    testNumber = 27;
    totalTests++;
    const payloadObj = {
      content: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
  ...
  it('Test case #28 should return errors ["content should not be empty"] when body {"content":"","status":"🚀","expireAfterTime":1}', async () => {
    testNumber = 28;
    totalTests++;
  ...
  it('Test case #29 should return errors ["content should not be empty","status expected string,received number"] when body {"content":"","status":123,"expireAfterTime":1}', async () => {
    testNumber = 29;
    totalTests++;
  ...
  it('Test case #30 should return errors ["content should not be empty","status only accepts 1 emoji"] when body {"content":"","status":"🚀🚀","expireAfterTime":1}', async () => {
    testNumber = 30;
    totalTests++;
    const payloadObj = { content: '', status: '🚀🚀', expireAfterTime: 1 };
    resolvedData = resolveVariables(payloadObj, globalContext);
  ...
  it('Test case #31 should return errors ["content should not be empty","status invalid emoji","status only accepts 1 emoji"] when body {"content":"","status":"","expireAfterTime":1}', async () => {
    testNumber = 31;
    totalTests++;
    const payloadObj = { content: '', status: '', expireAfterTime: 1 };
    resolvedData = resolveVariables(payloadObj, globalContext);
  ...
  it('Test case #32 should return errors ["content should not be empty","status expected string,received null"] when body {"content":"","status":null,"expireAfterTime":1}', async () => {
    testNumber = 32;
    totalTests++;
  ...
  it('Test case #33 should return errors ["content should not be empty","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'invalid_enum_value\'"] when body {"content":"","status":"🚀","expireAfterTime":"invalid_enum_value"}', async () => {
    testNumber = 33;
    totalTests++;
    const payloadObj = {
      content: '',
  ...
  it('Test case #34 should return errors ["content should not be empty","expireAfterTime required","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'undefined\'"] when body {"content":"","status":"🚀"}', async () => {
    testNumber = 34;
    totalTests++;
  ...
  it('Test case #35 should return errors ["content should not be empty","expireAfterTime should not be empty","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'\'"] when body {"content":"","status":"🚀","expireAfterTime":""}', async () => {
    testNumber = 35;
    totalTests++;
  ...
  it('Test case #36 should return errors ["content should not be empty","expireAfterTime invalid enum value. Expected 0 | 1 | 2 | 3 | 4 | 99,received \'null\'"] when body {"content":"","status":"🚀","expireAfterTime":null}', async () => {
    testNumber = 36;
    totalTests++;
  ...
  afterEach(async () => {
    ...
    const afterEachSteps =
      AddUserStatusRequest.options?.find((option) => option.afterEach)
        ?.afterEach || [];
  ...
  afterAll(async () => {
    const afterAllSteps =
      AddUserStatusRequest.options?.find((option) => option.afterAll)
        ?.afterAll || [];
    ...
    console.log(
      `📝 Saved result for add-user-status chunk single to ${filePath}`,
    );
  });
});
