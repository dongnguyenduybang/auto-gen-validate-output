    ...
    import { resolveCallAPI, resolveVariables, findReportsDirectory } from '../../../../../utils/helper';
    ...
    describe('Testcase for update-user-status', () => {
        ...
        beforeAll(async () => {
          ...
          requestConfig = typeof UpdateUserStatusRequest === 'function'
        ...
        beforeEach(async () => {
          ...
          if (beforeEachSteps.length > 0) {
            ...
            it('Test case #1 should return errors ["content expected string,received number"] when body {"content":123,"status":"🚀"}', async () => {
    testNumber = 1;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #2 should return errors ["content string must contain at most 50 character(s)"] when body {"content":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","status":"🚀"}', async () => {
    testNumber = 2;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #3 should return errors [] when body {"status":"🚀"}', async () => {
    testNumber = 3;
    totalTests++;
    const payloadObj = {"status":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #4 should return errors ["content should not be empty"] when body {"content":"","status":"🚀"}', async () => {
    testNumber = 4;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #5 should return errors ["content expected string,received null"] when body {"content":null,"status":"🚀"}', async () => {
    testNumber = 5;
    totalTests++;
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #6 should return errors ["status expected string,received number"] when body {"content":"defaultContent","status":123}', async () => {
    testNumber = 6;
    totalTests++;
    const payloadObj = {"content":"defaultContent","status":123};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'updateUserStatus',
            {"x-session-token":"{{token}}"},
            {"content":"defaultContent","status":123},
            globalContext
        );
        const data = response.data;
        ...
        failedTests.push({
            ...
            it('Test case #7 should return errors ["status only accepts 1 emoji"] when body {"content":"defaultContent","status":"🚀🚀"}', async () => {
    testNumber = 7;
    totalTests++;
    const payloadObj = {"content":"defaultContent","status":"🚀🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #8 should return errors ["status should not be empty","status invalid emoji","status only accepts 1 emoji"] when body {"content":"defaultContent","status":""}', async () => {
    testNumber = 8;
    totalTests++;
    const payloadObj = {"content":"defaultContent","status":""};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #9 should return errors [] when body {"content":"defaultContent"}', async () => {
    testNumber = 9;
    totalTests++;
    const payloadObj = {"content":"defaultContent"};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        ...
        failedTests.push({
            ...
            it('Test case #10 should return errors ["status expected string,received null"] when body {"content":"defaultContent","status":null}', async () => {
    testNumber = 10;
    totalTests++;
    const payloadObj = {"content":"defaultContent","status":null};
    resolvedData = resolveVariables(payloadObj, globalContext);
    ...
    try {
        const response = await resolveCallAPI(
            'updateUserStatus',
            {"x-session-token":"{{token}}"},
            {"content":"defaultContent","status":null},
            globalContext
        );
        const data = response.data;
        ...
        failedTests.push({
            ...
            it('Test case #11 should return errors [] when body {"content":"defaultContent","status":"🚀"}', async () => {
    testNumber = 11;
    totalTests++;
    const payloadObj = {"content":"defaultContent","status":"🚀"};
    resolvedData = resolveVariables(payloadObj, globalContext);
