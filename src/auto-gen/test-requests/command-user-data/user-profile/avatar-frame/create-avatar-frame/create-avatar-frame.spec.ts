    ...
    describe('Testcase for create-avatar-frame', () => {
        ...
        beforeAll(async () => {
          ...
          const beforeAllSteps = CreateAvatarFrameRequest.options[0]?.beforeAll || [];
        ...
        beforeEach(async () => {
          testCaseNumber++;
          const beforeEachSteps = CreateAvatarFrameRequest.options[0]?.beforeEach || [];
    ...
    try {
      ...
      afterEach(async () => {
          testCaseNumber++;
          const afterEachSteps = CreateAvatarFrameRequest.options[0]?.afterEach || [];
         ...
         afterAll(async () => {
          const afterAllSteps = CreateAvatarFrameRequest.options[0]?.afterAll || [];
